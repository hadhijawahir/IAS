				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="col-md-6">
								<div class="dash-item">
									<h6 class="item-title"><i class="fa fa-line-chart"></i>DAILY ATTENDANCE REPORT</h6>
									<div class="inner-item">
                                        <form action="admin-report-attendance.php" method="post">
                                                        <div class="dash-form">
                                                           
                                                            <div class="col-sm-6">
                                                                <label class="clear-top-margin"><i class="fa fa-calendar-alt"></i>DATE</label><input type="date" name="calendar" required>
										...
										<script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.6.0/Chart.min.js"></script>
                                            ...
                                            <script>                                               
                                                ...
                                                let massPopChart = new Chart(myChart, { // llet is a keyword
							...
							<div class="col-md-6">
								<div class="dash-item">
									<h6 class="item-title"><i class="fa fa-list"></i>MONTHLY ATTENDANCE REPORT</h6>
									<div class="inner-item">
                                        <form action="admin-report-attendance.php" method="post">
                                                        <div class="dash-form">
                                                    ...
                                                    if(isset($_POST['submit2'])){
                                                        ...
                                                        $resultattendance = mysqli_query($connection, $sqlattendance);
                                                            while($rowattendance = $resultattendance->fetch_assoc()) {
                                                                ...
                                                                $sqlsearch = "SELECT COUNT(subject_id) AS total FROM student_attendance WHERE subject_id='$subject' AND timestamp LIKE '$search_string%'";
                                                                $resultsearch = mysqli_query($connection, $sqlsearch);
                                                                
                                                                    while($rowsearch = $resultsearch->fetch_assoc()) {
                                                                            $count = $rowsearch['total'];
                                                                             echo 
                                                                                "<tr>
                                                                                <td> ".$subject."</td>";
                                                                            echo
